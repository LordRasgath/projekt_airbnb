...
with col1:
    ...
    houserules=st.number_input("Houserules",key="houserules",value=0.0,min_value=0.0,max_value=5.0,format="%0.1f",step=0.1)
...
with col2:
    ...
    total_rating=st.number_input("Total Rating",key="total_rating",value=0.0,min_value=0.0,max_value=5.0,format="%0.1f",step=0.1)
    communication=st.number_input("Communication",key="communication",value=0.0,min_value=0.0,max_value=5.0,format="%0.1f",step=0.1)
...
with col3:
    cleanliness=st.number_input("Cleanliness",key="cleanliness",value=0.0,min_value=0.0,max_value=5.0,format="%0.1f",step=0.1)
...
def resetPerson():
    ...
    st.session_state.number_rating=0
...
with col7:
    ...
    service_fee_guests=st.number_input("Service fee for guests (mandatory)",min_value=0.00,format="%0.01f",key="service_fee_guests")
...
with col8:
    ...
    avg_ppn_incl_discount=st.number_input("Average Price per night, incl. discount (mandatory)",min_value=0.00,format="%0.01f",key="avg_ppn_incl_discount")
    total_paid=st.number_input("Total price paid (mandatory)",min_value=0.00,format="%0.01f",key="total_paid")
    service_fee_landlord=st.number_input("Service fee for landlord (mandatory)",min_value=0.00,format="%0.01f",key="service_fee_landlord")
with col9:
    ...
    total_nights_excl_discount=st.number_input("Total nights excluding discount (mandatory)",min_value=0.00,format="%0.01f",key="total_nights_excl_discount")
